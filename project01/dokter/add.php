                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="add.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-4 col-form-label">Kategori</label>
                                    <div class="col-8">
                                        <input id="kategori" name="kategori" type="text" class="form-control" placeholder="('Umum', 'Spesialis', 'Bidan', 'Dokter Gigi', 'Anastesi', 'Bedah', 'Ginekolog')">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="alamat" class="col-4 col-form-label">Telpon</label>
                                    <div class="col-8">
